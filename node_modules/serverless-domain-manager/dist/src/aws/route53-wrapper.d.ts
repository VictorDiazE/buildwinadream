...
declare class Route53Wrapper {
     ...
     */
    changeResourceRecordSet(action: string, domain: DomainConfig): Promise<void>;
    /**
     * Gets Route53 HostedZoneId from user or from AWS
     */
    getRoute53HostedZoneId(domain: DomainConfig): Promise<string>;
}
